"""Run with the interpreter where Traversal 0.1.0 is installed."""
...
def main():
    ...
    if installed != "0.1.0":
        raise RuntimeError(f"This skill supports 0.1.0; installed: {installed}")
    if traversal.__version__ != installed or _native.__version__ != "0.1.0":
